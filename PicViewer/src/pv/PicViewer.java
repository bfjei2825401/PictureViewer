...
//		//showPanel.setOpaque(false);
//		int iScreenWidth = this.getWidth();
//		int iScreenHeight = this.getHeight();
//		ImageIcon icon = new ImageIcon(picture);
//		int iImageWidth=icon.getIconWidth();
//		int iImageHeight = icon.getIconHeight();
//		double dScreenProportion = 1.0*iScreenHeight/iScreenWidth;
//		double dImageProportion = 1.0*iImageHeight/iImageWidth;
//		if(iImageWidth>iScreenWidth&&iImageHeight>iScreenHeight){
//			if(dScreenProportion>dImageProportion){
//				iImageWidth=iScreenWidth;
...
//			}
//			else{
//				iImageHeight=iScreenWidth;
//				iImageWidth=(int) (((double)iImageHeight)/dImageProportion);
//			}
////			iImageHeight=iScreenHeight;
////			iImageWidth=iScreenWidth;
//			System.out.println("image: w " + iImageWidth + " ,h " + iImageHeight
//					+ " ,p1 " + dImageProportion);
//			//showLabel.setBounds(0, 0, iScreenWidth, iScreenHeight);
//		}else if(iImageWidth>iScreenWidth&&iImageHeight<iScreenHeight){
//			iImageWidth=iScreenWidth;
//			System.out.println("  p0>p1  h= " + iImageHeight);
//			//int iSuitableX = (int)((iScreenWidth-iPictureWidth)/2);
//			//int iSuitableY = (int)((iScreenHeight-iPictureHeight)/2);
//			//Image img = icon.getImage().getScaledInstance(iSuitableX, iSuitableY, Image.SCALE_SMOOTH);
////			showLabel.setIcon(new ImageIcon(img));
////			showLabel.setBounds(0, 0, iScreenWidth, iScreenHeight);
//		}else if(iImageWidth<iScreenWidth&&iImageHeight>iScreenHeight){
//			iImageHeight=iScreenHeight;
...
//			//int iSuitableX = (int)((iScreenWidth-iImageWidth)/2);
//			//int iSuitableY = (int)((iScreenHeight-iImageHeight)/2);
//			//showLabel.setBounds(iSuitableX, iSuitableY, iImageWidth, iImageWidth);
//		}
//		Image img = icon.getImage().getScaledInstance(iImageWidth, iImageHeight, Image.SCALE_SMOOTH);
//		showLabel.setIcon(new ImageIcon(img));
//		titleLabel.setText(picture);
//}
//		Image image = null;
//		try {
...
//			e.printStackTrace();
//		}
//		jImagePane.setBackgroundImage(image);
